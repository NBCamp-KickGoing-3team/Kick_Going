...
class MyPageViewController: UIViewController, UITableViewDataSource {
    ...
    func setupUI() {
        ...
        if let userEmail = currentUserEmail {
            ...
            statusLabel.numberOfLines = 0 // 여러 줄 표시 가능하도록 설정
        } else {
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            statusLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20), // 여백 추가
            statusLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -20), // 여백 추가
        ])
